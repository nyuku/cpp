...
/*   Updated: 2024/07/04 15:55:37 by angela           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
    ...
    //unsigned int deborde si on passe le cap des negatifs
    {
        ...
        else
        {
             ...
             if (amount >= this->_hp)
                ...
                this->_hp -= amount;
             if (this->_hp > 0)
                std::cout <<LILAC << this->_name << RESET_COLOR<< " has " <<LIGHT_GREEN<< this->_hp<<RESET_COLOR << " healt points left !" << std::endl<< std::endl;
            else
